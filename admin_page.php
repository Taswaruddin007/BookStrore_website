...
<section class="admin_dashboard">
  ...
  <div class="admin_box_container">
    ...
    <div class="admin_box">
      <button onclick="window.location.href='admin_book_page.php'" style="border: none;background-color:transparent;cursor:pointer; font-family:sans-serif;font-weight:bold;">Stocks</button>
    </div>
